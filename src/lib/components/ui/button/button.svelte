	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					"bg-destructive hover:bg-destructive/90 disabled:hover:bg-destructive focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 dark:disabled:hover:bg-destructive/60 text-white",
				outline:
