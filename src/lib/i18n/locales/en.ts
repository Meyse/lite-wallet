export const en: Record<string, string> = {
  ...
  'wallet.watchlist.emptyTitle': 'Watch Verus addresses',
  'wallet.watchlist.emptyDescription':
    'Follow the public balances of a VerusID or R-address without adding its keys.',
