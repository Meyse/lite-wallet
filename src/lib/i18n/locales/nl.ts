...
export const nl: Record<string, string> = {
  ...
  'wallet.manageAssets.currencyNameOrId': 'Currencynaam of ID',
  ...
  'wallet.identity.publicProfile.backToWatchlist': 'Terug naar volglijst',
  ...
  'wallet.addressBook.error.usefulNameRequired': 'Geef dit contact een andere naam dan het adres.',
  ...
  'wallet.watchlist.updateUnavailable': 'Huidige saldi niet beschikbaar · Laatst bekende waarden',
  'wallet.watchlist.updateUnavailableEmpty': 'Huidige saldi niet beschikbaar',
  'wallet.watchlist.loading': 'Volglijst laden…',
  'wallet.watchlist.loadingBalances': 'Openbare saldi laden…',
  'wallet.watchlist.retry': 'Opnieuw proberen',
  ...
  'wallet.watchlist.backToDetail': 'Terug naar gevolgd adres',
  ...
  'wallet.watchlist.addSheet.identityFound': 'VerusID gevonden',
  'wallet.watchlist.addSheet.addressFound': 'R-adres gevonden',
  'wallet.watchlist.addSheet.nameOptional': 'Geef dit adres een naam (optioneel)',
  'wallet.watchlist.addSheet.namePlaceholder': 'bijv. Mam',
  'wallet.watchlist.addSheet.publicInfo':
    'De saldi van dit adres zijn openbaar en iedereen kan ze zien.',
  ...
  'wallet.contacts.inContacts': 'In contacten',
