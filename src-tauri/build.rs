...
const APP_COMMANDS: &[&str] = &[
    ...
    "get_active_assets",
    "set_active_assets",
    "get_asset_preferences",
    "set_asset_preferences",
    "discover_vrpc_assets",
    ...
    "acknowledge_pending_eth_submission",
    "get_balances",
    ...
    "clear_pending_identity_profile_update",
    "preflight_identity_profile_update",
    "encode_identity_profile_image",
    "get_identity_profile_publication",
    "confirm_identity_profile_update",
    "review_identity_profile_publication",
    "discard_identity_profile_publication",
    "verify_generic_request_signature",
    "sign_generic_response",
    "build_and_sign_generic_response",
    "post_generic_response_callback",
    ...
    "prepare_provisioning_signature",
    "confirm_provisioning_signature",
    "store_generic_provisioning_job",
    "list_identity_provisioning_jobs",
    "refresh_identity_provisioning_jobs",
