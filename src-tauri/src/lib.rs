...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            wallet::get_asset_preferences,
            wallet::set_asset_preferences,
            wallet::discover_vrpc_assets,
            ...
            identity::get_pending_identity_profile_updates,
            identity::clear_pending_identity_profile_update,
            identity::preflight_identity_profile_update,
            identity::encode_identity_profile_image,
            identity::get_identity_profile_publication,
            identity::confirm_identity_profile_update,
            identity::review_identity_profile_publication,
            identity::discard_identity_profile_publication,
